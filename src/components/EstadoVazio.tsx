...
export function EstadoVazio({
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-2xl bg-superficie px-6 py-12 text-center shadow-sm">
      ...
      <div className="space-y-1">
        ...
        <p className="mx-auto max-w-sm text-sm text-mutado">{descricao}</p>
      </div>
      {acao}
    </div>
  );
